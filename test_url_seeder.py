...
class TestAsyncUrlSeederBM25:
    ...
    async def test_basic_bm25_scoring(self, seeder):
        ...
        config = SeedingConfig(
            source="sitemap",
            extract_head=True,
            query="case studies or testimonilas or success stories",
            scoring_method="bm25",
            max_urls=200,
            verbose=True,
    ...
    async def test_multi_word_complex_queries(self, seeder):
        ...
        complex_queries = [
            "case studies, testimonial, pr success stories",
            "about the company or their goals and mission",
